...
namespace imageprocessing {
  ...
  void removal_elt(std::vector< std::vector< cv::Point > > &contours, std::vector< cv::Vec4i > hierarchy, const cv::Size& size_image, const long int& areaRatio = 1500, const double& lowAspectRatio = 0.25, const double& highAspectRatio = 2.25);
  ...
  void forward_transformation_contour(const std::vector < cv::Point >& contour, std::vector< cv::Point2f >& output_contour, const cv::Mat& translation_matrix = cv::Mat::eye(3, 3, CV_64F), const cv::Mat& rotation_matrix = cv::Mat::eye(3, 3, CV_64F), const cv::Mat& scaling_matrix = cv::Mat::eye(3, 3, CV_64F));

  // Function to make forward transformation -- INPUT CV::POINT2F
  void forward_transformation_contour(const std::vector < cv::Point2f >& contour, std::vector< cv::Point2f >& output_contour, const cv::Mat& translation_matrix = cv::Mat::eye(3, 3, CV_64F), const cv::Mat& rotation_matrix = cv::Mat::eye(3, 3, CV_64F), const cv::Mat& scaling_matrix = cv::Mat::eye(3, 3, CV_64F));

  // Function to make inverse transformation -- INPUT CV::POINT
  void inverse_transformation_contour(const std::vector < cv::Point >& contour, std::vector< cv::Point2f >& output_contour, const cv::Mat& translation_matrix = cv::Mat::eye(3, 3, CV_64F), const cv::Mat& rotation_matrix = cv::Mat::eye(3, 3, CV_64F), const cv::Mat& scaling_matrix = cv::Mat::eye(3, 3, CV_64F));

  // Function to make inverse transformation -- INPUT CV::POINT2F
  void inverse_transformation_contour(const std::vector < cv::Point2f >& contour, std::vector< cv::Point2f >& output_contour, const cv::Mat& translation_matrix = cv::Mat::eye(3, 3, CV_64F), const cv::Mat& rotation_matrix = cv::Mat::eye(3, 3, CV_64F), const cv::Mat& scaling_matrix = cv::Mat::eye(3, 3, CV_64F));
