...
public:
    ...
    void setupUi(QMainWindow *GodEye)
    {
        ...
        runButton->setGeometry(QRect(960, 620, 100, 27));
        QIcon icon1;
...
""));
        ...
        imgButton->setGeometry(QRect(960, 580, 95, 27));
        classifierBox = new QGroupBox(centralWidget);
        classifierBox->setObjectName(QStringLiteral("classifierBox"));
        classifierBox->setGeometry(QRect(944, 390, 136, 151));
        svm = new QRadioButton(classifierBox);
        svm->setObjectName(QStringLiteral("svm"));
        svm->setGeometry(QRect(0, 30, 113, 23));
        svm->setChecked(true);
        boost = new QRadioButton(classifierBox);
        boost->setObjectName(QStringLiteral("boost"));
        boost->setGeometry(QRect(0, 60, 113, 23));
        knn = new QRadioButton(classifierBox);
        knn->setObjectName(QStringLiteral("knn"));
        knn->setGeometry(QRect(0, 90, 113, 23));
        ann = new QRadioButton(classifierBox);
        ann->setObjectName(QStringLiteral("ann"));
        ann->setGeometry(QRect(0, 120, 113, 23));
    ...
    void retranslateUi(QMainWindow *GodEye)
    {
        ...
        classifierBox->setTitle(QApplication::translate("GodEye", "Classifier", 0));
        svm->setText(QApplication::translate("GodEye", "SVM", 0));
        boost->setText(QApplication::translate("GodEye", "Boost", 0));
        knn->setText(QApplication::translate("GodEye", "KNN", 0));
        ann->setText(QApplication::translate("GodEye", "ANN", 0));
    } // retranslateUi
